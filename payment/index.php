...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="bg-white shadow-md rounded-lg p-6 w-96">
        <h1 class="text-2xl font-bold text-center text-gray-700 mb-4">Stripe Payment</1>
        <h2 class="text-2xl font-bold text-center text-gray-700 mb-4">Total Bill <?php echo "$ ". ($_POST['total']/100)." USDT";?></12>
